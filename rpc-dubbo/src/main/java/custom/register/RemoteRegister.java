...
public class RemoteRegister {
    ...
    public static void saveFile() {
        try {
            FileOutputStream outputStream = new FileOutputStream("rpc-dubbo/remote-register.txt");
    ...
    public static Map<String, List<URL>> getFile() {
        try {
            FileInputStream fileInputStream = new FileInputStream("rpc-dubbo/remote-register.txt");
